...
if __name__ == '__main__':
    ...
    if bal_currency<min_wallet_amount:
        transfer_amount_currency=Decimal(str(random.uniform(float(min_wallet_amount-bal_currency), float(max_wallet_amount-bal_currency)))).quantize(Decimal("0.00000001"))
    ...
    if bal_currency>max_wallet_amount:
        transfer_amount_currency=Decimal(str(random.uniform(float(bal_currency-min_wallet_amount), float(1)))).quantize(Decimal("0.00000001"))
        transfer_amount=(transfer_amount_currency/rate).quantize(Decimal("0.01"))
